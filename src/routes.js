...
import CustomerServices from "./views/customerNew/CustomerServices";
import ContactUs from "./views/customerNew/contactus";
import MyOrder from "./views/customerNew/my-oder";
import MyServices from "./views/customerNew/My-services";
...
import ServiceProviderView from "./views/customerNew/ServiceProviderView";
import ServiceBook from "./views/customerNew/ServiceBook";
import Product from "./views/customerNew/Product";
import Service from "./views/customerNew/Service";
...
import AdminServiceProviderList from "./views/admin/AdminServiceProviderList";
import AdminBookedServideList from "./views/admin/AdminBookedServiceList";
...
import ServiceProfileUpdate from "./views/service-provider/ServiceProfileUpdate";
...
import SellerRefundRequestListPending from "./views/seller/SellerRefundRequestListPending";
import SellerRefundRequestListRefunded from "./views/seller/SellerRefundRequestListRefunded";
...
import ServiceMyShop from "./views/service-provider/ServiceMyShop";
...
import ServiceMyShopEdit from "views/service-provider/ServiceMyShopEdit";
...
import AdminServiceProviderDetail from "views/admin/AdminServiceProviderDetail";
...
import Try from "views/service-provider/Try";
import ServicePortfolioInsert from "views/service-provider/ServicePortfolioInsert";
import ServicePortfolioEdit from "views/service-provider/ServicePortfolioEdit";
import BookedServiceList from "views/service-provider/BookedServiceList";
//
...
const customerRoutes = [{
    ...
    { path: "/services", name: "", element: CustomerServices, index: true },
    ...
    { path: "/account-service", name: "", element: MyServices, index: true },
    ...
    {
        path: "/book/service/:id/:serviceId",
        name: "",
        element: ServiceBook,
        index: true,
    },
    { path: "/product/:id", name: "", element: Product, index: true },
    { path: "/service/:id", name: "", element: Service, index: true },
    {
...
const adminRoutes = [{
    ...
    },
    {
        ...
        name: "",
        element: SellerRefundRequestListPending,
        index: false,
    },
    // {
    ...
    // },
    {
        ...
        name: "",
        element: SellerRefundRequestListRefunded,
        index: false,
    },
    // {
    ...
    {
        path: "/service/service-provider-list",
        name: "sub-sub-category/view",
    ...
    },
    {
        ...
        name: "sub-sub-category/view",
        element: AdminBookedServideList,
        index: false,
    },
    {
    ...
    },
    {
        ...
        name: "sub-sub-category/view",
        element: AdminServiceProviderDetail,
        index: false,
    },
    {
...
const serviceRoutes = [
    ...
    },
    {
        path: "/shop/view",
        name: "",
        element: ServiceMyShop,
        index: false,
    },
    {
        path: "/add/portfolio",
        name: "",
        element: ServicePortfolioInsert,
        index: false,
    },
    {
        path: "/edit/portfolio/:_id",
        name: "",
        element: ServicePortfolioEdit,
        index: false,
    },
    {
        path: "/seller-refund-list",
...
export { customerRoutes, adminRoutes, sellerRoutes, serviceRoutes };