...
import DefaultLayoutServiceProvider from "layout/DefaultLayoutServiceProvider";
...
import ServicePos from "views/service-provider/SellerPos";
...
function MainComp() {
  ...
  return (
    ...
    /> */}
        ...
        <Route path="/service" name="Home" element={<NotFound404 />} />
        <Route
          path="/service/pos"
          name="Home"
          element={
        ...
        <Route
          path="/service/*"
          name="Home"
          element={<DefaultLayoutServiceProvider />}
        />
        {/* ============================= CUSTOMER ============================= */}
