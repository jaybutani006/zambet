                  ...
                  >
                    <thead className="thead-light">
                      <tr>
                        ...
                        <th style={{ width: "50%" }}>Policy Type</th>
                          ...
                          <tr key={index}>
                            ...
                            <td>
                              <Link
                                ...
                                to={`/admin/policies/view/${item?._id}`}
                                state={item}
                              >
                              ...
                              <Link
                                className="btn btn-primary btn-sm m-1"
                                to={`/admin/policies/edit/${item?._id}`}
                                state={item}
                              >
...
export default AdminPoliciesList;
