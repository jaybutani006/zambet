...
function AdminTermsAndConditionsList() {
  ...
  const handlePolicyDelete = (policyId, index) => {
    if (
      window.confirm(
        `Are you sure you want to delete ${policyList?.[index]?.title || ""}`
      )
    ) {
      const config = {
        method: "delete",
                      ...
                      <div className="row">
                        ...
                        {/* <div className="col-12 col-sm-4 mt-2 mt-sm-0">
                          <button
                            onClick={(e) => {
                              e.preventDefault();
                              navigate("/admin/termsAndConditions/add");
                            }}
                            className="btn btn-primary"
                          >
                            Add T&Cs
                        ...
                        policyList.map((item, index) => (
                          <tr key={index}>
                            ...
                            <td>
                              ...
                              <Link
                                className="btn btn-primary btn-sm m-1"
                                to={`/admin/termsAndConditions/edit/${item?._id}`}
                                state={item}
                              >
