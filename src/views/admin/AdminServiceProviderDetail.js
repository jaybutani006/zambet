...
function AdminSellersView() {
  ...
  const handleSubmitActiveDeactiveStatus = (activeDeactiveStatus) => {
    console.log(activeDeactiveStatus);
    axios({
      method: "put",
      url: process.env.REACT_APP_BASEURL + "/api/service_provider/status",
      params: {
        _id: mainState?._id,
      },
      headers: {
      ...
      data: JSON.stringify({
        service_provider_status: activeDeactiveStatus,
      }),
    })
      .then((response) => {
  ...
  const handleConfirmDelete = () => {
    handleSubmitActiveDeactiveStatus(
      mainState?.status === "pending" ? "approve" : "pending"
    );
  ...
  const apiGetSellerDetails = () => {
    axios({
      method: "get",
      url: process.env.REACT_APP_BASEURL + "/api/service_provider/detail",
      params: {
        _id: itemId,
      },
      headers: {
      ...
      .then(function (response) {
        ...
        setServiceProData(response?.data?.data);
    ...
    >
      <div className="content container-fluid">
        ...
        <div className="flex-between d-sm-flex row align-items-center justify-content-between mb-2 mx-1">
          <div>
            <Link
              to="/admin/service/service-provider-list"
          ...
          <>
            ...
            <div className="row">
                  ...
                  <div className="card-body" style={{ textAlign: "left" }}>
                    ...
                    >
                      ...
                      <div className="w-50">
                        ...
                        <div className="flex-start">
                          <div>
                            <h5>Vendor Type : Service Provider</h5>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    >
                      ...
                      <div className="w-50">
                        ...
                        <div className="flex-start">
                          <div>
                            <h5>
                              Shop Address : {mainState?.shop_address || "...."}
                            </h5>
                          </div>
                        </div>
                      </div>
              ...
              <div className="col-12">
                <h4 className="text-center" style={{ display: "block", marginTop: "1rem" }}>Portfolios</h4>
                <div className="row">
                {mainState?.service_provider_portfolios?.length > 0 &&
                  mainState?.service_provider_portfolios.map((item) => (
                    // <div className="row">
                    <div
                      className="col-3"
                        id={item._id}
