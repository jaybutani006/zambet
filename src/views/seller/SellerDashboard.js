...
function SellerDashboard() {
  ...
  const apiGetAdminDashboard = () => {
    axios({
      method: "get",
      url: process.env.REACT_APP_BASEURL + "/api/vendor/sellerdashboard",
      headers: {
  ...
  // console.log(dashboard.best_selling_products);
  return (
    <>
      <main
        id="content"
                      ...
                      <div className="flex-between align-items-center mb-1">
                        <div style={{ textAlign: "left" }}>
                          ...
                          <span
                            ...
                            style={{ color: "#F14A16 !important" }}
                          >
                            {dashboard?.total_pending_order || 0}
                          </span>
                        </div>
                        <div className="mt-2">
                          <i
                      ...
                      <div className="flex-between align-items-center mb-1">
                        <div style={{ textAlign: "left" }}>
                          ...
                          <span
                            ...
                            style={{ color: "#F14A16 !important" }}
                          >
                            {dashboard?.confirmed_order_status || 0}
                          </span>
                        </div>
                        <div className="mt-2">
                          <i
                      ...
                      <div className="flex-between align-items-center gx-2 mb-1">
                        <div style={{ textAlign: "left" }}>
                          ...
                          <span
                            ...
                            style={{ color: "#F14A16 !important" }}
                          >
                            {dashboard?.processing_order_status || 0}
                          </span>
                        </div>
                        <div className="mt-2">
                          <i
                      ...
                      <div className="flex-between align-items-center gx-2 mb-1">
                        <div style={{ textAlign: "left" }}>
                          ...
                          <span
                            ...
                            style={{ color: "#F14A16 !important" }}
                          >
                            {dashboard?.out_for_delivery_order_status || 0}
                          </span>
                        </div>
                        <div className="mt-2">
                          <i
                        ...
                        >
                          ...
                          >
                            ...
                            <span className="card-title h3">
                              {dashboard?.deliverd_order_status || 0}
                            </span>
                          </div>
                          <div>
                      ...
                      <div className="col-sm-6 col-lg-3 column-divider-sm">
                        ...
                        >
                          ...
                          >
                            ...
                            <span className="card-title h3">
                              {dashboard?.cancel_order_status || 0}
                            </span>
                          </div>
                          <span className="icon icon-sm icon-soft-secondary icon-circle ml-3">
                      ...
                      <div className="col-sm-6 col-lg-3 column-divider-lg">
                        ...
                        >
                          ...
                          >
                            ...
                            <span className="card-title h3">
                              {dashboard?.returned_order_status || 0}
                            </span>
                          </div>
                          <span className="icon icon-sm icon-soft-secondary icon-circle ml-3">
                ...
                <div className="card-body">
                  <div className="row">
                    {dashboard?.best_selling_products &&
                      dashboard?.best_selling_products?.map((item) => (
                        <div
                        ...
                        >
                          <div className="grid-card">
                            <div className="text-center mt-3">
                              <img
                                style={{ height: "90px" }}
                                src={item.pphoto ? item.pphoto : productImage}
