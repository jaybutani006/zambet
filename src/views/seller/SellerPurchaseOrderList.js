...
function SellerPurchaseOrderList() {
  ...
  const handleExport = () => {
    axios({
      ...
      params: { queryType: "Seller_PurchaseOrders" },
      headers: {
  ...
  const handlePurchaseOrderReturn = (poid) => {
    axios({
      method: "put",
      ...
      .then((response) => {
        alert("successfully submitted purchase order return request");
      })
      .catch((error) => {
        defaultAPIErrorHandler(error);
      });
                              ...
                              <div className="dropdown">
                                ...
                                >
                                  ...
                                  <Link
                                    ...
                                    // state={item}
                                    onClick={() =>
                                      handlePurchaseOrderReturn(item._id)
                                    }
                                  >
                                    <i className="tio-receipt-outlined" />
                                    Return
                                  </Link>
                                  <Link
                                    className="dropdown-item"
...
export default SellerPurchaseOrderList;
