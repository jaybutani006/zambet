...
function SellerProfileUpdate1() {
  ...
  const handleChangePassword = () => {
    if (!formData1.password) return alert(`Password can't be empty.`);
    else if (formData1.password.length < 8)
      return alert(`Password length must be greater than 8 characters`);

    if (!formData1.confirm_password)
      return alert(`Confirm Password can't be empty.`);
    else if (formData1.confirm_password.length < 8)
      return alert(`Confirm Password length must be greater than 8 characters`);

    if (formData1.password === formData1.confirm_password)
    ...
    if (formData1.password !== formData1.confirm_password) {
      ...
      const data = JSON.stringify({
        old_password: formData1.password,
        newPassword: formData1.confirm_password,
      });
      ...
      const config = {
        ...
        url:
          ...
          "/api/service_provider/changepassword",
        headers: {
  ...
  const handleUpdateProfile = () => {
    ...
    formData.append("vendor_photo", formData1.vendor_photo);

    const config = {
      method: "put",
      url:
        process.env.REACT_APP_BASEURL + "/api/service_provider/updatebasicinfo",
      headers: {
        ...
        .then((response) => {
          ...
          // Handle the response data here
            ...
            setFormData1({
              ...
              phone: response.data.data.contect_no,
        ...
        <div className="page-header">
          <div className="row align-items-end">
            ...
            {/* <div className="col-sm-auto">
              <Link className="btn btn-primary" to="/service/dashboard">
              ...
              <div className="card mb-3 mb-lg-5" id="generalDiv">
                ...
                >
                  <img
                    ...
                    src={shopDetail?.company_logo || productImage}
