...
function ServiceHeader({ toggleSideBar, isOpen }) {
                      ...
                      <div className="media align-items-center text-break">
                        ...
                        <div className="media-body">
                          <span className="card-title h6">
                            {shopDetail
                              ? `${shopDetail?.first_name}` +
                                `${shopDetail?.last_name}`
                              : "..."}
                          </span>
                          <span className="card-text">
                            {shopDetail ? shopDetail?.email_address : "..."}
                          </span>
                        </div>
                      </div>
                    </div>
